...
A C++ UI library based on SFML and ThorVG library for simple and fast UI creation in C++. This Library can create multiple UI elements like buttons, sliders, pane, labels and further more to be added.
